...
const StickyHeader = ({
  ...
  console.log("Header Props:", navbarLink)
  ...
  return (
    <motion.header
      ...
      animate={isSticky ? { y: 0, opacity: 1 } : { y: -80, opacity: 0 }}
      transition={{ duration: 0.3 }}
      className="fixed top-0 left-0 w-full z-50 bg-transparent md:!bg-[#4d1313]"
    >
